...
export default function Projects() {
  ...
  return (
    ...
    >
      <h2
        id="projects-heading"
        className="text-3xl p-2 md:text-4xl lg:text-5xl font-bold mb-8 text-center bg-gradient-to-r from-sky-500 to-blue-400 bg-clip-text text-transparent"
      >
              ...
              <div className="h-40 overflow-hidden">
                <img
                  ...
                  onError={(e) => {
                    ...
                    e.target.src = "https://via.placeholder.com/400x200/1e293b/64748b?text=Preview+no+disponible";
                  }}
                />
              </div>
              <div className="p-4 md:p-5">
                ...
                {project.description.length > 100 && (
                  <button
                    ...
                    className="text-sky-400 hover:text-sky-300 text-xs font-medium mb-3 transition-colors flex items-center gap-1"
                ...
                <div className="flex items-center justify-between p-2 md:p-4">
                  ...
                  <div className="flex-1 px-2 md:px-4">
                    <div className="flex justify-center">
                      <img
                        src={selectedImages[currentImageIndex] || "https://via.placeholder.com/800x500/1e293b/64748b?text=Imagen"}
                        alt={`Vista ${currentImageIndex + 1} de ${selectedImages.length}`}
                        className="w-full max-h-[70vh] object-contain"
                        loading="eager"
                        onError={(e) => {
                          e.target.src = "https://via.placeholder.com/800x500/334155/94a3b8?text=Error+de+carga";
                        }}
                      />
                    </div>
